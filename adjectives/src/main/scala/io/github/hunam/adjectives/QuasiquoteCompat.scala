/*
 * Borrowed from [[https://github.com/scalamacros/sbt-example-paradise210/blob/master/macros/src/main/scala/Compat.scala sbt-example-paradise210]]
 * Original code by Eugene Burmako
 */
